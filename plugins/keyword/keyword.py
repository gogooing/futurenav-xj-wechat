...
class Keyword(Plugin):
    def __init__(self):
        ...
        try:
            ...
            logger.warn(f"[keyword]dir path: {curdir}")
            ...
            logger.warn("[keyword] init failed, ignore or see https://github.com/gogooing/futurenav-xj-wechat/tree/master/plugins/keyword .")
            raise e
